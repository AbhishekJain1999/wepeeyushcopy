...
class _MyAppState extends State<MyApp> {
  var channel = MethodChannel("welang");
  var text = "To avail all the credit benefits, please complete your KYC process.";
  var isLoading= false;
  ...
  changeText() async {
    var currTim = DateTime.now().millisecondsSinceEpoch;
    loading(true);
    channel.invokeMethod<String>('getStrViaWelang',"cd_desc_under_paid_process").then((value) async {
      // currTim = DateTime.now().millisecondsSinceEpoch-currTim;
      // await Future.delayed(const Duration(seconds: 2));
      setText("$value ( in ${currTim}ms )");
      loading(false);
